...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="#">Cliente<i class="fa fa-address-book menu-icon fa-2x" aria-hidden="true"></i></a>
            </li>
            <li>
                <a href="#">Quartos<i class="fa fa-bed menu-icon fa-2x" aria-hidden="true"></i></a>
            </li>
            <li>
                <a href="#">Usuario<i class="fa fa-user menu-icon fa-2x" aria-hidden="true"></i>
                </a>
            </li>
            <li>
                <a href="#">Aluguel<i class="fa fa-user menu-icon fa-2x" aria-hidden="true"></i>
                </a>
            </li>
